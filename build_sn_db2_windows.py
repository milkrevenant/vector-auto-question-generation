...
# ── ❶ 경로 설정 ──────────────────────────────
SRC_DIR = "C:\\Users\\milkrevenant\\Documents\\UG\\snoriginal\\db"
...
MAX_TOK = 512   # 이미 선언돼 있지만 명시적 사용
_model.max_seq_length = MAX_TOK
_model.tokenizer.model_max_length = MAX_TOK
